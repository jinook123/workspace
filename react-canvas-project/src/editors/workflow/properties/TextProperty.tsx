				...
				<Col span={8}>
					<Form.Item label="Font Size" colon={false}>
						{getFieldDecorator('fontSize', {
							initialValue: label.fontSize || '32',
						})(
							<Select>
				...
				<Col span={6}>
					<Form.Item>
						{getFieldDecorator('fontWeight', {
							...
							initialValue: label.fontWeight === 'bold',
						})(
							<Tag.CheckableTag className="rde-action-Tag.chekckableTags">
								<Icon name="bold" />
							</Tag.CheckableTag>,
						)}
					</Form.Item>
				...
				<Col span={6}>
					<Form.Item>
						{getFieldDecorator('fontStyle', {
							valuePropName: 'checked',
							initialValue: label.fontStyle === 'italic',
						})(
							<Tag.CheckableTag className="rde-action-Tag.chekckableTags">
								<Icon name="italic" />
							</Tag.CheckableTag>,
				...
				<Col span={6}>
					<Form.Item>
						{getFieldDecorator('linethrough', {
							valuePropName: 'checked',
							initialValue: label.linethrough,
						})(
							<Tag.CheckableTag className="rde-action-Tag.chekckableTags">
				...
				<Col span={6}>
					<Form.Item>
						{getFieldDecorator('textAlign.left', {
							valuePropName: 'checked',
							initialValue: label.textAlign === 'left',
						})(
							<Tag.CheckableTag className="rde-action-Tag.chekckableTags">
				...
				<Col span={6}>
					<Form.Item>
						{getFieldDecorator('textAlign.center', {
							valuePropName: 'checked',
							initialValue: label.textAlign === 'center',
						})(
							<Tag.CheckableTag className="rde-action-Tag.chekckableTags">
				...
				<Col span={6}>
					<Form.Item>
						{getFieldDecorator('textAlign.right', {
							valuePropName: 'checked',
							initialValue: label.textAlign === 'right',
						})(
							<Tag.CheckableTag className="rde-action-Tag.chekckableTags">
				...
				<Col span={6}>
					<Form.Item>
						{getFieldDecorator('textAlign.justify', {
							valuePropName: 'checked',
							initialValue: label.textAlign === 'justify',
						})(
							<Tag.CheckableTag className="rde-action-Tag.chekckableTags">
				...
				<Col span={12}>
					<Form.Item label="Char Spacing" colon={false}>
						{getFieldDecorator('charSpacing', {
							...
							initialValue: label.charSpacing,
						})(<Slider min={0} max={100} />)}
					</Form.Item>
				</Col>
			</React.Fragment>
