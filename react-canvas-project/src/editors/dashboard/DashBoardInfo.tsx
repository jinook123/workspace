...
import DashBoardSiderContainer from './DashBoardSiderContainer';
...
class DashBoardInfo extends Component<IProps> {
	state = {
		isEdit: false,
	};
	...
	render() {
		...
		return (
			<DashBoardSiderContainer title={i18n.t('workflow.workflow-info')} icon="cog" extra={extra}>
				{component}
			</DashBoardSiderContainer>
		);
	}
}

export default Form.create<IProps>()(DashBoardInfo);
