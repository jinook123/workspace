...
import WorkflowSiderContainer from './DashBoardSiderContainer';
...
class DashBoardGlobalParameters extends Component<IProps> {
	state = {
...
export default Form.create<IProps>()(DashBoardGlobalParameters);
